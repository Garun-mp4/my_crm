...
Internal CRM for lead research, qualification, and human-approved outreach.

This repository is based on Twenty `v2.39.0` and keeps the upstream history as a separate parent in the bootstrap merge. Twenty remains available through the `upstream` fetch remote; all project work is pushed to `origin`.
